...
| UC | Actor | Precondition | Main Flow | Linked FRs |
|----|----|----|----|---|
| UC-001 | User | Logged in | Click "New" → Enter title/content → Auto-save → Appears in list | FR-002, FR-004, FR-009 |
| UC-002 | User | Logged in, has notes | Type in search → Results filter in real-time → Click to open | FR-007, FR-003 |
| UC-003 | User | Logged in | Create folder → Move notes via drag-drop → View in subfolder | FR-006, FR-009 |
| UC-004 | User | Note open | Click editor → Type → 3 sec pause → Auto-save → "Saved" indicator | FR-004 |
| UC-005 | User | Note selected | Right-click → Confirm delete → Moved to Trash → Can restore | FR-005 |
| UC-006 | User | Viewing notes | Right-click note → "Pin" → Moves to top with star icon | FR-008 |
...
|--------|--------|-------|
| FR-001 | UC-001 through UC-006 (all require auth) | TC-001 to TC-020 |
| FR-002 | UC-001 | TC-021 to TC-030 |
| FR-003 | UC-002 | TC-031 to TC-040 |
| FR-004 | UC-004 | TC-041 to TC-050 |
| FR-005 | UC-005 | TC-051 to TC-060 |
| FR-006 | UC-003 | TC-061 to TC-080 |
| FR-007 | UC-002 | TC-081 to TC-100 |
| FR-008 | UC-006 | TC-101 to TC-110 |
| FR-009 | UC-001, UC-003 | TC-111 to TC-125 |
